    ...
    <form action="cadastrar-plataforma.php" method="post">
        <div class="row">
            <div class="input-container quarter">
                ...
                <input onclick="removeMessagErrorPlataforma()" name="plataform" id="plataform" class="row-input" type="text">
            </div>
        </div>

        <?php if($error != null) { ?>
            <div id="erro-plataforma"class="row error-message"><?=$error?></div>
        <?php } ?>
